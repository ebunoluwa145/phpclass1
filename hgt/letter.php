...
if(isset($_POST["submit"])){
    ...
    $sql = "INSERT INTO orders(firstname,  nickname, gender, qualification) VALUES('$firstname', '$nickname', '$gender', '$qualification')";
...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <input type="checkbox" name ="qualification[]" value = "MSC">Master
            <br>
            <input type="checkbox" name ="qualification[]" value = "BSC">Degree
            <br>
            <input type="checkbox" name ="qualification[]" value = "BSCE">school leaving cert
            <br>
            <input type="checkbox" name ="qualification[]" value = "HND">bachelors
            <div class="submit">
